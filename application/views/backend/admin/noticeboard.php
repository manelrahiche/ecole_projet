		...
		<ul class="nav nav-tabs bordered">
			<li class="active">
            	<a href="#list" data-toggle="tab"><i class="entypo-menu"></i> 
					<?php echo ('Liste des panneaux d\'affichage');?>
                    	</a></li>
			<li>
            	<a href="#add" data-toggle="tab"><i class="entypo-plus-circled"></i>
					<?php echo ('Ajouter un panneau d\'affichage');?>
                    	</a></li>
		</ul>
    	<!------CONTROL TABS END------>
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?admin/noticeboard/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('Avis');?></label>
                                <div class="col-sm-5">
