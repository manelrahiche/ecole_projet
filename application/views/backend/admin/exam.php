		...
		<ul class="nav nav-tabs bordered">
			<li class="active">
            	<a href="#list" data-toggle="tab"><i class="entypo-menu"></i> 
					<?php echo ('Liste des contrôles');?>
                    	</a></li>
			<li>
            	<a href="#add" data-toggle="tab"><i class="entypo-plus-circled"></i>
					<?php echo ('Ajouter un contrôle');?>
                    	</a></li>
		</ul>
    	<!------CONTROL TABS END------>
		<div class="tab-content">
            ...
            <div class="tab-pane box active" id="list">
                <table  class="table table-bordered table-hover table-striped datatable" id="table_export">
                	<thead>
                		<tr>
                    		<th><div><?php echo ('Titre du contrôle');?></div></th>
                    		<th><div><?php echo ('Date');?></div></th>
                    		<th><div><?php echo ('Remarque');?></div></th>
                ...
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?admin/exam/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('Titre du contrôle');?></label>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group">
                        		...
                        		<div class="form-group">
                                  ...
                                  <button type="submit" class="btn btn-info"><?php echo ('Ajouter un contrôle');?></button>
                              	</div>
								</div>
                    </form>                
                </div>                
