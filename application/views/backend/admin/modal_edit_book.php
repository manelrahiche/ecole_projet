...
<div class="tab-pane box active" id="edit" style="padding: 5px">
    <div class="box-content">
        ...
        <?php echo form_open(base_url() . 'index.php?admin/book/do_update/'.$row['book_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label"><?php echo ('Auteur');?></label>
                    <div class="col-sm-5">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label"><?php echo ('Prix');?></label>
                    <div class="col-sm-5">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <select name="status" class="form-control">
                            <option value="available" <?php if($row['status']=='available')echo 'selected';?>><?php echo ('Disponible');?></option>
                            <option value="unavailable" <?php if($row['status']=='unavailable')echo 'selected';?>><?php echo ('Indisponible');?></option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                  <div class="col-sm-offset-3 col-sm-5">
                      <button type="submit" class="btn btn-info"><?php echo ('Modifier le livre');?></button>
                  </div>
                </div>
        </form>
        <?php endforeach;?>
