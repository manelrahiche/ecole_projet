		...
		<div class="panel panel-primary" data-collapsed="0">
        	<div class="panel-heading">
            	<div class="panel-title" >
					...
					<?php echo ('Formulaire d\'ajout groupé d\'élèves');?>
            	</div>
            </div>
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/student_bulk_add/import_excel/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label"><?php echo ('Sélectionnez le fichier Excel');?></label>
						...
						<div class="col-sm-5">
                         ...
                         <a href="<?php echo base_url();?>uploads/blank_excel_file.xlsx" target="_blank" 
                         		class="btn btn-info btn-sm"><i class="entypo-download"></i>Télécharger un fichier Excel vierge</a>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select name="class_id" class="form-control" data-validate="required" data-message-required="<?php echo ('Valeur Requise');?>">
                    ...
                    <div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<button type="submit" class="btn btn-info"><?php echo ('Télécharger et importer');?></button>
						</div>
					</div>
                <?php echo form_close();?>
            </div>
