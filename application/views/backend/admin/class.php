		...
		<ul class="nav nav-tabs bordered">
			<li class="active">
            	<a href="#list" data-toggle="tab"><i class="entypo-menu"></i> 
					<?php echo get_phrase('Liste des classes');?>
                    	</a></li>
			<li>
            	<a href="#add" data-toggle="tab"><i class="entypo-plus-circled"></i>
					<?php echo get_phrase('Ajouter une classe');?>
                    	</a></li>
		</ul>
    	<!------CONTROL TABS END------>
            ...
            <div class="tab-pane box active" id="list">
                ...
                <table class="table table-bordered table-hover table-striped datatable" id="table_export">
                	<thead>
                		<tr>
                    		<th><div>#</div></th>
                    		<th><div><?php echo get_phrase('Nom du classe');?></div></th>
                    		<th><div><?php echo get_phrase('Numero du classe');?></div></th>
                    		<th><div><?php echo get_phrase('Enseignant');?></div></th>
                ...
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?admin/classes/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        <div class="padded">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('Enseignant');?></label>
                                <div class="col-sm-5">
                        ...
                        <div class="form-group">
                              <div class="col-sm-offset-3 col-sm-5">
                                  <button type="submit" class="btn btn-info"><?php echo get_phrase('Ajouter');?></button>
                              </div>
							</div>
                    </form>                
                </div>                
