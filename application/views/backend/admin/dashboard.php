		...
		<div class="row">
            <div class="col-md-4">
                ...
                <div class="tile-stats tile-cyan">
                    ...
                    <h3><?php echo get_phrase('Frais perçus');?></h3>
            ...
            <div class="col-md-4">
                ...
                <div class="tile-stats tile-red">
                    ...
                    <h3><?php echo get_phrase('Élèves');?></h3>
            ...
            <div class="col-md-4">
                ...
                <div class="tile-stats tile-blue">
                    ...
                    <h3><?php echo get_phrase('Enseignants');?></h3>
            ...
            <div class="col-md-4">
                ...
                <div class="tile-stats tile-green">
                    ...
                    <h3><?php echo get_phrase('Présence d\'aujourd\'hui');?></h3>
            ...
            <div class="col-md-4">
                ...
                <div class="tile-stats tile-brown">
                    ...
                    <h3><?php echo get_phrase('Frais impayés');?></h3>
            ...
            <div class="col-md-4">
                ...
                <div class="tile-stats tile-pink">
                    ...
                    <h3><?php echo get_phrase('Boîte de réception');?></h3>
