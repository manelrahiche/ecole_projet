    	...
    	<!------CONTROL TABS END------>
            ...
            <div class="tab-pane  <?php if(!isset($edit_data) && !isset($personal_profile) && !isset($academic_result) )echo 'active';?>" id="list">
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="table table-bordered table-hover table-striped">
                	<tr>
                        <td><?php echo ('Selectionner le contrôle');?></td>
                        <td><?php echo ('Selectionner la classe');?></td>
                        <td><?php echo ('Selectionner la matiére');?></td>
                        <td>&nbsp;</td>
                	</tr>
                	<tr>
                        <td>
                        	<select name="exam_id" class="form-control"  style="float:left;">
                                <option value=""><?php echo ('Selectionner un contrôle');?></option>
                                <?php 
                        ...
                        <td>
                        	<select name="class_id" class="form-control"  onchange="show_subjects(this.value)"  style="float:left;">
                                <option value=""><?php echo ('Selectionner une classe');?></option>
                                <?php 
                        ...
                        <td>
							...
							<?php 
                                ...
                                <select name="<?php if($class_id == $row['class_id'])echo 'subject_id';else echo 'temp';?>" 
                                    ...
                                    <option value="">Matiére du classe<?php echo $row['name'];?></option>
                ...
                <table class="table table-bordered table-hover table-striped" >
                    <thead>
                        <tr>
                            <td><?php echo ('Elève');?></td>
                            <td><?php echo ('Note obtenue');?>(/20)</td>
