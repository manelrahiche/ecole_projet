                ...
                <table class="table table-bordered table-hover table-striped" >
                    <thead>
                        <tr>
                            ...
                            <td><?php echo ('Mark obtained');?>(sur 20)</td>
                            <td><?php echo ('control continu');?>(sur 20)</td>
                            <td><?php echo ('devoir 1');?>(sur 20)</td>
                            <td><?php echo ('devoir 2');?>(sur 20)</td>
                            <td><?php echo ('projet');?>(sur 20)</td>
                            <td><?php echo ('examen');?>(sur 20)</td>
                    ...
                    <tbody>
						...
						foreach($students as $row):
							...
							<tr>
								...
								<td>
									 <input type="float" value="<?php echo $row2['mark_obtained'];?>" name="mark_obtained" class="form-control"  />
												
								</td>
                                <td>
									 <input type="float" value="<?php echo $row2['control'];?>" name="control" class="form-control"  />
												
								</td>
                                <td>
									 <input type="float" value="<?php echo $row2['dev1'];?>" name="dev1" class="form-control"  />
												
								</td>
                                <td>
									 <input type="float" value="<?php echo $row2['dev2'];?>" name="dev2" class="form-control"  />
												
								</td>
                                <td>
									 <input type="float" value="<?php echo $row2['projet'];?>" name="projet" class="form-control"  />
												
								</td>
                                <td>
									 <input type="float" value="<?php echo $row2['exam'];?>" name="exam" class="form-control"  />
